...
public class Koan extends TDLKoan{	
	...
	public void talk_to_master(){
		...
		//recursive execution of operation of composite
		waitress.printMenu();
		assertEquals(___, COUT.getLastLines(22));
		
		//walking over tree using iterator
		waitress.printVegetarianMenu();
		assertEquals(___, COUT.getLastLines(15));
	}
}